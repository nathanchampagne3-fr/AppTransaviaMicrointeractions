import svgPaths from "./svg-kx4laiz0aa";
...
export default function ChoixBagae() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Choix bagae">
      <Container />
    </div>
  );
}